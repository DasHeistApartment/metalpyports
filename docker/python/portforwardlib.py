#!/usr/bin/python
# This code was taken from https://github.com/gryphius/port-forward/tree/8224a71dce5eba3587cee6ea73d417dbe7a5f869 and slightly modified because some routers don't allow port forwarding for other hosts
...
def open_port(
    ...
    conn = http.client.HTTPConnection(
        parsedurl.hostname,
        parsedurl.port,
        source_address=(internal_client, 0),
    )
